...
namespace Apache.Calcite.Cosmos.Adapter.Tests
{
    ...
    public class CosmosDifferentialTests
    {
        ...
        [
            ...
            ("SELECT c.\"id\" FROM products AS c WHERE JSON_VALUE(c.\"DOC\", '$.price') > 50", false),
            ...
            ("SELECT c.\"id\" FROM products AS c WHERE c.\"$.category\" <> 'bikes'", false),
            ("SELECT c.\"id\" FROM products AS c WHERE NOT (c.\"$.category\" <> 'bikes')", false),
            ("SELECT c.\"id\" FROM products AS c WHERE NOT (JSON_VALUE(c.\"DOC\", '$.price') > 50)", false),
            ...
            ("SELECT c.\"id\" FROM products AS c WHERE NOT (c.\"$.category\" = 'bikes' AND JSON_VALUE(c.\"DOC\", '$.price') > 50)", false),
            ("SELECT c.\"id\" FROM products AS c WHERE NOT (c.\"$.category\" = 'bikes' OR JSON_VALUE(c.\"DOC\", '$.price') > 50)", false),
            ...
            ("SELECT ARRAY_SLICE(JSON_VALUE(c.\"DOC\", '$.tags'), 0, 1) FROM products AS c WHERE c.\"id\" = '1'", false),
            ("SELECT ARRAY_SLICE(JSON_VALUE(c.\"DOC\", '$.tags'), 1, 1) FROM products AS c WHERE c.\"id\" = '1'", false),
            ("SELECT ARRAY_SLICE(JSON_VALUE(c.\"DOC\", '$.tags'), 2, 1) FROM products AS c WHERE c.\"id\" = '1'", false),
            ("SELECT ARRAY_SLICE(JSON_VALUE(c.\"DOC\", '$.tags'), 0, 2) FROM products AS c WHERE c.\"id\" = '1'", false),
            ...
            ("SELECT ARRAY_UNION(JSON_VALUE(c.\"DOC\", '$.tags'), JSON_VALUE(c.\"DOC\", '$.tags')) FROM products AS c WHERE c.\"id\" = '1'", false),
            ("SELECT ARRAY_INTERSECT(JSON_VALUE(c.\"DOC\", '$.tags'), JSON_VALUE(c.\"DOC\", '$.tags')) FROM products AS c WHERE c.\"id\" = '1'", false),
            ...
            ("SELECT c.\"id\" FROM products AS c WHERE JSON_VALUE(c.\"DOC\", '$.price') < 100", false),
            ("SELECT c.\"id\" FROM products AS c WHERE JSON_VALUE(c.\"DOC\", '$.price') >= 120", false),
            ...
            ("SELECT c.\"id\" FROM products AS c WHERE JSON_VALUE(c.\"DOC\", '$.price') > 50 OR c.\"$.category\" = 'shoes'", false),
            ("SELECT c.\"id\" FROM products AS c WHERE JSON_VALUE(c.\"DOC\", '$.price') > 50 AND c.\"$.category\" = 'shoes'", false),
            ...
            ("SELECT c.\"id\" FROM products AS c WHERE CARDINALITY(JSON_VALUE(c.\"DOC\", '$.tags')) = 2", false),
            ...
            ("SELECT c.\"id\" FROM typed AS c WHERE CAST(JSON_VALUE(c.\"DOC\", '$.price') AS INTEGER) = 30", false),
            ("SELECT c.\"id\" FROM typed AS c WHERE CAST(JSON_VALUE(c.\"DOC\", '$.price') AS INTEGER) > 10", false),
            ("SELECT c.\"id\" FROM typed AS c WHERE CAST(JSON_VALUE(c.\"DOC\", '$.price') AS INTEGER) > 0 ORDER BY c.\"id\"", true),
            ...
            ("SELECT c.\"id\" FROM typed AS c WHERE CAST(JSON_VALUE(c.\"DOC\", '$.big') AS INTEGER) = 2147483647", false),
            ("SELECT c.\"id\" FROM typed AS c WHERE CAST(JSON_VALUE(c.\"DOC\", '$.big') AS BIGINT) = 9223372036854775807", false),
            ("SELECT c.\"id\" FROM typed AS c WHERE CAST(JSON_VALUE(c.\"DOC\", '$.big') AS INTEGER) > 5", false),
            ...
            ("SELECT c.\"id\" FROM typed AS c WHERE SAFE_CAST(JSON_VALUE(c.\"DOC\", '$.price') AS INTEGER) = 30", false),
            ("SELECT c.\"id\" FROM typed AS c WHERE SAFE_CAST(JSON_VALUE(c.\"DOC\", '$.price') AS INTEGER) > 10", false),
            ("SELECT c.\"id\" FROM typed AS c WHERE SAFE_CAST(JSON_VALUE(c.\"DOC\", '$.big') AS INTEGER) = 2147483647", false),
            ("SELECT c.\"id\" FROM typed AS c WHERE SAFE_CAST(JSON_VALUE(c.\"DOC\", '$.label') AS VARCHAR) = 'bikes'", false),
            ("SELECT c.\"id\" FROM typed AS c WHERE CAST(JSON_VALUE(c.\"DOC\", '$.price') AS INTEGER) IS NULL", false),
            ("SELECT c.\"id\" FROM typed AS c WHERE CAST(JSON_VALUE(c.\"DOC\", '$.price') AS DOUBLE) = 30.7", false),
            ("SELECT c.\"id\" FROM typed AS c WHERE CAST(JSON_VALUE(c.\"DOC\", '$.name') AS VARCHAR) = 'Stringy'", false),
            ("SELECT c.\"id\", CAST(JSON_VALUE(c.\"DOC\", '$.price') AS INTEGER) FROM typed AS c", false),
            ("SELECT CAST(JSON_VALUE(c.\"DOC\", '$.price') AS INTEGER) FROM typed AS c WHERE c.\"$.category\" = 'a'", false),
            ...
            ("SELECT CAST(JSON_VALUE(c.\"DOC\", '$.price') AS INTEGER), COUNT(*) FROM typed AS c GROUP BY CAST(JSON_VALUE(c.\"DOC\", '$.price') AS INTEGER)", false),
        ];
