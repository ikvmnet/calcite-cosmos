...
namespace Apache.Calcite.Cosmos.Adapter.Tests.Sql
{
    ...
    public class CosmosCastTests
    {
        ...
        /// predicate — which for <c>VECTORDISTANCE</c> is the predicate that bounds the search.
        /// </remarks>
        [TestMethod]
        ...
        /// <remarks>
        /// And the value is bound, not inlined — it is the part that varies with what is being asked.
        /// </remarks>
        [TestMethod]
        ...
        /// <remarks>
        /// And a cast of a literal to an exact type, which truncates or throws depending on the value —
